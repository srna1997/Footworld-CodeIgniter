...
<div align="center">
    <label class="btn btn-secondary btn-lg">
        <a class="btn text-white" href="<?php echo base_url(); ?>admin/create_club">Dodajte novi klub</a>
    </label>
</div>
<table class="table">
...
<?php foreach($klub as $club) : ?>
  ...
  <tbody>
    <tr>
        ...
        <td><a class="btn btn-dark" href="<?php echo base_url(); ?>admin/edit_club/<?php echo $club['id_klub']; ?>">Edit</a></td>
        <td><a class="btn btn-danger" href="<?php echo base_url(); ?>admin/delete_club/<?php echo $club['id_klub']; ?>">Delete</a></td>
        <br>
      </tr>
