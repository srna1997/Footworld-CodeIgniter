...
<div align="center">
    <label class="btn btn-secondary btn-lg">
        <a class="btn text-white" href="<?php echo base_url(); ?>moderator/create_player">Dodajte novog igrača</a>
    </label>
</div>
...
<?php foreach($igrac as $player) : ?>
        <tr>
            ...
            <td><?php echo word_limiter ($player['opis'],4); ?></td> 
            <td><a class="btn btn-dark" href="<?php echo base_url(); ?>moderator/edit_player/<?php echo $player['id_igrac']; ?>">Uredi</a></td>
            <td><a class="btn btn-danger" href="<?php echo base_url(); ?>moderator/delete_player/<?php echo $player['id_igrac']; ?>">Delete</a></td>
